    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('ADMIN', 'Administrador'), ('PROF', 'Professor'), ('ALUNO', 'Aluno')], default='ALUNO', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formacao', models.CharField(choices=[('G', 'Graduação'), ('M', 'Mestrado'), ('D', 'Doutorado')], default='G', max_length=30)),
                ...
                ('pdf', models.FileField(blank=True, null=True, upload_to='equipes/pdfs/')),
